  ...
  return (
    <View style={styles.tabBar}>
      <TouchableOpacity style={[styles.tabItem, activeTab === 'Recomendados' && styles.activeTab]} onPress={() => switchTab('Recomendados')}>
        <Text style={[styles.tabTitle, activeTab === 'Recomendados' ? styles.activeTabTitle : null]}>Mesas</Text>
      </TouchableOpacity>
      <TouchableOpacity style={[styles.tabItem, activeTab === 'Seguindo' && styles.activeTab]} onPress={() => switchTab('Seguindo')}>
        <Text style={[styles.tabTitle, activeTab === 'Seguindo' ? styles.activeTabTitle : null]}>Jogadores</Text>
      </TouchableOpacity>
    </View>
  );
}
